...
CREATE TABLE `Role` (
    ...
    `name` ENUM('CUSTOMER', 'ADMIN', 'STAFF') NOT NULL,
...
CREATE TABLE `Product` (
    ...
    INDEX `Product_categoryId_collectionId_status_idx`(`categoryId`, `collectionId`, `status`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ReturnRequest` (
    ...
    `unpackingVideoUrl` VARCHAR(191) NULL,
